...
class PreferencesAmirDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesAmirDialog"
    prefernces = {}

    def __init__(self):
        """__init__ - This function is typically not called directly.
        Creation of a PreferencesAmirDialog requires redeading the associated ui
        file and parsing the ui definition extrenally,
        and then calling PreferencesAmirDialog.finish_initializing().

        Use the convenience function NewPreferencesAmirDialog to create
    ...
    def finish_initializing(self, builder):
        ...
        self.__record_type = "http://wiki.ubuntu.com/Quickly/RecordTypes/Amir/Preferences"
    ...
    def get_preferences(self):
        ...
        preferences for amir. Creates a couchdb record if
        necessary.
        """
...
def NewPreferencesAmirDialog():
    """NewPreferencesAmirDialog - returns a fully instantiated
    PreferencesAmirDialog object. Use this function rather than
    creating a PreferencesAmirDialog instance directly.
    """

    #look for the ui file that describes the ui
    ui_filename = os.path.join(getdatapath(), 'ui', 'PreferencesAmirDialog.ui')
    if not os.path.exists(ui_filename):
        ui_filename = None

    builder = gtk.Builder()
    builder.add_from_file(ui_filename)
    dialog = builder.get_object("preferences_amir_dialog")
    dialog.finish_initializing(builder)
    return dialog

if __name__ == "__main__":
    dialog = NewPreferencesAmirDialog()
    dialog.show()
    gtk.main()
