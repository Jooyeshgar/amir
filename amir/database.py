...
class Database:
    def __init__(self):
        logging.debug('db constructed - sqlite:///'+config.data_path+'/tutorial.db')

        engine = create_engine('sqlite:///'+config.data_path+'/tutorial.db', echo=(config.options.verbose>1))
