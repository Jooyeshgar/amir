...
def upgrade(migrate_engine):
    ...
    op.execute({"id": 1 , "code":"01"  , "name": u"بانکها"                      , "parent_id": 0 , "lft": 1 , "rgt": 2  , "type":2},
               ...
               {"id": 24, "code":"15"  , "name": u"برگشت از خرید و تخفیفات"     , "parent_id": 0 , "lft": 77, "rgt": 82 , "type":2},
               {"id": 25, "code":"16"  , "name": u"برگشت از فروش و تخفیفات"     , "parent_id": 0 , "lft": 83, "rgt": 88 , "type":2},
               ...
               {"id": 38, "code":"17"  , "name": u"سایر حسابهای دریافتنی"       , "parent_id": 0 , "lft": 89, "rgt": 94 , "type":2},
               {"id": 39, "code":"18"  , "name": u"سایر حسابهای پرداختنی"       , "parent_id": 0 , "lft": 95, "rgt": 100, "type":2},
               {"id": 40, "code":"1701", "name": u"مالیات ارزش افزوده خرید"     , "parent_id": 38, "lft": 90, "rgt": 91 , "type":2},
               {"id": 41, "code":"1801", "name": u"مالیات ارزش افزوده فروش"     , "parent_id": 39, "lft": 96, "rgt": 97 , "type":2},
               {"id": 42, "code":"1501", "name": u"برگشت از خرید"               , "parent_id": 24, "lft": 78, "rgt": 79 , "type":2},
               {"id": 43, "code":"1601", "name": u"برگشت از فروش"               , "parent_id": 25, "lft": 84, "rgt": 85 , "type":2},
               ...
               {"id": 53, "code":"1502", "name": u"تخفیفات خرید"                , "parent_id": 24, "lft": 80, "rgt": 81 , "type":2},
               {"id": 55, "code":"1602", "name": u"تخفیفات فروش"                , "parent_id": 25, "lft": 86, "rgt": 87 , "type":2},
               {"id": 56, "code":"1702", "name": u"عوارض خرید"                  , "parent_id": 38, "lft": 92, "rgt": 93 , "type":2},
               {"id": 57, "code":"1802", "name": u"عوارض فروش"                  , "parent_id": 39, "lft": 98, "rgt": 99 , "type":2})
